...
public class LCS {
  ...
  private String getLCSubSequence(int i, int k) {
    ...
    if(lcs[i - 1][k] == lcs[i][k])
      ...
      // Bei diagonalem Schritt Buchstabe (aus X) merken => Übereinstimmung
  ...
  public Set<String> getAllSubseqs() {
    ...
    getLCSubSequences(al, "", n, m, lcs[n][m]);
    return al;
  }

  public void getLCSubSequences(Set<String> list, String seq, int i, int k, int reminder) {
